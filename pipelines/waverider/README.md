# Waverider wave statistics Ingestion Pipeline

The Waverider wave statistics ingestion pipeline was created from a cookiecutter template. This README file contains
