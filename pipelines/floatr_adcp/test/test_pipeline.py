...
def test_floatr_dat_adcp_pipeline_007():
    config_path = Path("pipelines/floatr_adcp/config/pipeline_pws.yaml")
    config = PipelineConfig.from_yaml(config_path)
    # Manually set to storage so tests pass
    config.storage.parameters["storage_root"] = "storage"
    ...
    test_file = "pipelines/floatr_adcp/test/data/input/PWS_007_adcp.20250723.220000.dat"
    expected_file = "pipelines/floatr_adcp/test/data/expected/pws.floatr_adcp-007.a1.20250723.220000.nc"
