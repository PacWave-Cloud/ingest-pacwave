...
lander at PacWave. It is currently set up to read the in-instrument bin-averaged water velocity dataset.
...
1. If you are not running the echo sounder, navigate to `pipelines/sig250_avgd/config` and open `retriever.yaml`. 
